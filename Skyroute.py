...
stations_under_construction = ["Templeton", "Nanaimo"]
...
def get_end():
    ...
    if end_point_letter in landmark_choices:
        ...
        print(f"You are headed to {end_point}.")
        return end_point
    else:
        print("Sorry, that's not a landmark we have data on. Let's try this again...")
        get_end()
...
def get_route(start_point, end_point):
    # Gets a set of metro stations for that start point landmark.
    start_stations = vc_landmarks[start_point]
    # Gets a set of metro stations for that end point landmark.
